				...
				<h1>
					...
					if ($village->loyalty == '100') {
						if ($village->loyalty > '33') {
							...
							$color = "re";
						} ?><div id="loyality" class="<?php echo $color; ?>" style="margin-left:60px;"><?php echo LOYALTY; ?> <?php echo floor($village->loyalty); ?>%</div><?php }

?></h1>
				<?php if ($village->capital != '0') {
					?>
												<div id="loyality" class="cap" style="margin-left:9px;margin-top: -10px;"><font size=2 color=grey>(<?php if($session->lang == 'tr'){ echo 'Merkez'; }else{ echo 'Capital'; } ?>)</font></div>
											<?php }else{
												?>
<div id="loyality" class="cap" style="margin-left:9px;margin-top: -10px;"><font size=2 color=grey>(<?php if($session->lang == 'tr'){ echo 'Köy'; }else{ echo 'Village'; } ?>)</font></div>
												<?php
											} ?>
